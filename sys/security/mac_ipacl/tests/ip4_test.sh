...
sysctl security.mac.ipacl.rules=${jid1}@1@epair0b@AF_INET@192.168.42.2@-1,${jid2}@1@epair1b@AF_INET@127.1.32.1@-1,${jid2}@1@@AF_INET@198.18.0.1@15,${jid2}@0@@AF_INET@198.18.0.12@-1 >/dev/null

# Verify if security.mac.ipacl.rules allow jail to set certain IPv4 address
exec_test ok ipv4 epair0b '192.168.42.2' 16 ${jid1}
exec_test fl ipv4 epair0b '192.168.43.3' 16 ${jid1}
...
sysctl security.mac.ipacl.rules=${jid1}@1@@AF_INET@169.254.0.0@16,${jid1}@0@@AF_INET@169.254.123.0@24,${jid1}@1@@AF_INET@169.254.123.123@-1,${jid1}@1@@AF_INET@198.51.100.0@24,${jid1}@0@@AF_INET@198.51.100.100@-1
# Add more tests from Link-Local space and Documentation(TEST-NET-3)
exec_test ok ipv4 epair0b '169.254.121.121' 16 ${jid1}
exec_test fl ipv4 epair0b '169.254.123.121' 16 ${jid1}
exec_test ok ipv4 epair0b '169.254.123.123' 16 ${jid1}
exec_test fl ipv4 epair0b '169.253.121.121' 16 ${jid1}

exec_test ok ipv4 lo0 '198.51.100.001' 24 ${jid1}
exec_test ok ipv4 lo0 '198.51.100.254' 24 ${jid1}
exec_test fl ipv4 epair0b '198.51.100.100' 24 ${jid1}
exec_test fl ipv4 epair0b '198.151.100.100' 24 ${jid1}
