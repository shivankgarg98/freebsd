...
sysctl security.mac.ipacl.rules=1@1@epair0b@AF_INET@192.168.42.2@-1,3@1@epair1b@AF_INET@127.1.32.1@-1,3@1@@AF_INET@198.18.0.1@15,3@0@@AF_INET@198.18.0.12@-1 >/dev/null
...
exec_test ok ipv4 epair1b '127.1.32.1' 24 3
exec_test fl ipv4 epair0b '127.1.32.1' 24 1

# Verify if scurity.mac.ipacl.rule allow jail to set any address in subnet
exec_test ok ipv4 epair1b '198.18.0.192' 15 3
exec_test ok ipv4 epair1b '198.18.132.121' 15 3
exec_test fl ipv4 epair1b '197.1.123.123' 15 3
exec_test fl ipv4 epair1b '198.18.0.12' 15 3 #last rule disllow the ip in that subnet

# Verify if secutiy.mac.ipacl.rule=TODO(interface wildcard) allow jail to set certain IPv4 address
exec_test ok ipv4 lo0 '198.18.0.192' 15 3
exec_test ok ipv4 lo0 '198.18.132.121' 15 3
exec_test fl ipv4 lo0 '197.1.123.123' 15 3
exec_test fl ipv4 lo0 '198.18.0.12' 15 3 #last rule disllow the ip in that subnet
