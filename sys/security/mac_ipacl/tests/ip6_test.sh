...
exec_test ok ipv6 epair0b '2001:db8::1111' 16 ${jid1}
exec_test fl ipv6 epair0b '2001:db8::1112' 16 ${jid1}
exec_test ok ipv6 epair1b '2001:2::1234:1234' 48 ${jid2}
exec_test fl ipv6 epair0b '2001:2::1234:1234' 48 ${jid1}
...
exec_test ok ipv6 epair0b 'fc00::0000:1234' 48 ${jid1}
exec_test ok ipv6 epair0b 'fc00::1112:1234' 48 ${jid1}
exec_test fl ipv6 epair0b 'f800::2222:2200' 48 ${jid1}
exec_test fl ipv6 epair0b 'f800::2222:22ff' 48 ${jid1}

exec_test ok ipv6 epair0b 'fc00::1111:2111' 64 ${jid1}
exec_test fl ipv6 epair0b 'fc00::1111:2211' 64 ${jid1}
exec_test fl ipv6 epair0b 'fc00::1111:22aa' 48 ${jid1}
exec_test ok ipv6 epair0b 'fc00::1111:2299' 48 ${jid1}

#add more tests of documentation range IPV6
exec_test ok ipv6 epair0b '2001:db8:abcd:bcde:cdef:def1:ef12:f123' 32 ${jid1}
exec_test ok ipv6 epair0b '2001:db8:1111:2222:3333:4444:5555:6666' 32 ${jid1}
exec_test fl ipv6 epair0b '2000:db9:1111:2222:3333:4444:5555:6666' 32 ${jid1}
exec_test fl ipv6 lo0 '2001:db8::abcd' 32 ${jid1}
