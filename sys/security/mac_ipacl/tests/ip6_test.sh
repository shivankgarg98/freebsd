...
sysctl security.mac.ipacl.rules=1@1@epair0b@AF_INET6@2001:db8::1111@-1,3@1@epair1b@AF_INET6@001:470:1e01:5ea::11@-1,3@1@@AF_INET6@fe80::@10,3@0@@AF_INET6@fe80::abcd@-1 >/dev/null
...
exec_test ok ipv6 epair1b '001:470:1e01:5ea::11' 24 3
exec_test fl ipv6 epair0b '001:470:1e01:5ea::11' 24 1

# Verify if scurity.mac.ipacl.rules allow jail to set any address in subnet
exec_test ok ipv6 epair1b 'FE80::1101:1221' 15 3
exec_test ok ipv6 epair1b 'FE80::abab' 15 3
exec_test ok ipv6 epair1b 'FE80::1' 64 3
exec_test fl ipv6 epair1b 'FE80::abcd' 15 3 #last rule disllow the ip in that subnet

# Verify if secutiy.mac.ipacl.rules (interface wildcard) allow jail to set certain IPv4 address
exec_test ok ipv6 lo0 'FE80::1101:1221' 15 3
exec_test ok ipv6 lo0 'FE80::abab' 32 3
exec_test ok ipv6 lo0 'FE80::1' 64 3
exec_test fl ipv6 lo0 'FE80::abcd' 15 3 #last rule disllow the ip in that subnet
